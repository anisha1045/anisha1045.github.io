...
Anisha Bhaskar Torres is an incoming sophomore pursuing a BS in Computer Science at the University of Texas at Austin, set to graduate May 2027. In college, she has been actively involved in Texas Latin Dance, Circle K International, and Engineering and Computational Learning of Artificial Intelligence in Robotics (ECLAIR). Anisha is passionate about using computer science to make a meaningful, positive difference in the lives of others. Along with her DREU experience, she is currently exploring quantum computing through the Freshman Research Initiative at UT Austin. In her free time, she loves reading, dancing, and spending time with her family. Feel free to contact her at anishabhaskartorres@gmail.com.
...
Her website can be found here: https://eshort.github.io

## About My Project

Anisha's research project focuses on investigating the effects of human feedback on a reinforcement learning technique known as policy shifting. The study aims to explore how different types of human feedback influence the robot's ability to learn and adapt its behavior accordingly. The specific tasks the robot will perform and the detailed types of feedback including verbal cues, body language, facial expressions, and silence, to be analyzed will be determined as the project progresses. This project has the potential to enhance knowledge of human-robot interaction and improve the efficiency of policy shifting.
